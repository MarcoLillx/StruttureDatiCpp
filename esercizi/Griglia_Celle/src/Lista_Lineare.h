...
#ifndef SRC_LISTA_LINEARE_H_
#define SRC_LISTA_LINEARE_H_
...
public:
    ...
    */
    ...
    virtual void scrivi_elemento(const tipoelem &elemento_scritto, posizione posizione_elemento) = 0;

    // metodo per leggere un elemento in una determinata poszione della lista
    virtual tipoelem leggi_elemento(posizione posizione_selezionata) const = 0;
    ...
    virtual void inserisci_elemento(const tipoelem &elemento_inserito, posizione posizione_selezionata) = 0;

    // metodo per cancellare dalla lista un elemento in una determinata poszione
    virtual void rimuovi_elemento(posizione elemento_eliminato) = 0;

    // metodo per inserire un elemento in testa alla lista
    virtual void inserisci_in_testa(const tipoelem &elemento_inserito) = 0;
};



#endif /* SRC_LISTA_LINEARE_H_ */
